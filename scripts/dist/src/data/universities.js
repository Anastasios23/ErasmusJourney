...
exports.getDepartmentsByUniversity = exports.getProgramsByLevel = exports.getAllPrograms = exports.getUniversityNames = exports.getUniversityById = exports.getAllUniversities = exports.CYPRUS_UNIVERSITIES = void 0;
exports.CYPRUS_UNIVERSITIES = [
    {
        id: "ucy",
...
var getAllUniversities = function () {
    return exports.CYPRUS_UNIVERSITIES.filter(function (uni) { return uni.name && uni.name.trim() !== ""; });
};
exports.getAllUniversities = getAllUniversities;
var getUniversityById = function (id) {
    return exports.CYPRUS_UNIVERSITIES.find(function (uni) { return uni.id === id; });
};
exports.getUniversityById = getUniversityById;
var getUniversityNames = function () {
    return exports.CYPRUS_UNIVERSITIES.map(function (uni) { return uni.name; });
};
exports.getUniversityNames = getUniversityNames;
var getAllPrograms = function () {
    var programs = [];
    exports.CYPRUS_UNIVERSITIES.forEach(function (uni) {
        uni.faculties.forEach(function (faculty) {
            faculty.departments.forEach(function (dept) {
                programs.push.apply(programs, dept.programs);
            });
        });
    });
    return programs;
...
var getProgramsByLevel = function (level) {
    return (0, exports.getAllPrograms)().filter(function (program) { return program.level === level; });
};
exports.getProgramsByLevel = getProgramsByLevel;
var getDepartmentsByUniversity = function (universityId) {
    var university = (0, exports.getUniversityById)(universityId);
    if (!university)
        return [];
    var departments = [];
    university.faculties.forEach(function (faculty) {
        departments.push.apply(departments, faculty.departments.filter(function (dept) { return dept.name && dept.name.trim() !== ""; }));
    });
    return departments;
};
exports.getDepartmentsByUniversity = getDepartmentsByUniversity;
