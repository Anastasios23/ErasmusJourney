...
async function main() {
  ...
  console.log(
    `✅ Created ${courseMatching.length} sample course matching forms`,
  );
  ...
  console.log(
    `✅ Created ${livingExpenses.length} sample living expenses forms`,
  );
...
async function createSampleUsers() {
  ...
  for (const user of userData) {
    try {
      ...
      console.log(`Error with user ${user.email}:`, error);
    }
  }
...
async function createSampleStories(users: any[]) {
  const storyData = [
    {
      ...
      data: {
        ...
        funFact:
          "I learned to cook traditional Czech svíčková and now make it for my family back in Cyprus!",
        bestMemory:
          "Watching the sunrise from Prague Castle with my international friends on New Year's Day - it felt like the beginning of a new chapter in my life.",
      },
    },
    {
      userId: users[1].id,
      ...
      data: {
        ...
        challenges:
          "The fast-paced Catalan dialect was challenging at first, and the different academic schedule took some adjustment. Finding affordable housing near the university was competitive, but the student housing office helped me find a great shared apartment with local students.",
        personalGrowth:
          "This experience made me more creative and confident in expressing my ideas. Living with Spanish flatmates improved my language skills dramatically and taught me about Spanish family values and traditions. I also became more environmentally conscious, inspired by Barcelona's smart city initiatives.",
        recommendations:
          "Join the architecture student association - they organize amazing field trips! Try to live with local students rather than just internationals to really improve your Spanish. Explore beyond the touristy areas; neighborhoods like Gràcia and Poblenou have amazing hidden gems.",
        wouldRecommend: "Absolutely",
        overallRating: 5,
        socialLifeRating: 5,
        academicRating: 5,
        ...
        funFact:
          "I sketched over 200 architectural details around the city and created my own Barcelona architecture guidebook!",
        bestMemory:
          "Watching the sunset from Park Güell with my international friends while discussing our dream architecture projects.",
      },
    },
    {
      userId: users[2].id,
      ...
      data: {
        ...
        academicExperience:
          "TU Berlin's engineering program is world-renowned for a reason. The labs are equipped with the latest technology, and professors are leaders in their fields. I particularly enjoyed the 'Industry 4.0' course where we worked with real automotive companies. The emphasis on sustainability and green technology aligns perfectly with my career goals.",
        culturalExperience:
          "Berlin's history is fascinating and tragic, but the city has rebuilt itself as a symbol of freedom and creativity. I visited historical sites like the Brandenburg Gate and Berlin Wall, but also experienced the vibrant art scene in neighborhoods like Kreuzberg and Friedrichshain. The city never sleeps, and there's always something happening.",
        challenges:
          "German bureaucracy can be overwhelming for international students - so many forms and procedures! The winter was harsh and dark, which affected my mood initially. Also, making German friends took patience since they can seem reserved at first, but once you break the ice, they're incredibly loyal and fun.",
        personalGrowth:
          "This experience taught me the importance of precision and methodology in engineering - very German traits that I now apply to my work. I also learned to appreciate different approaches to problem-solving and became more environmentally conscious through exposure to Germany's sustainability initiatives.",
        recommendations:
          "Learn German before you go - it makes a huge difference in connecting with locals and understanding the culture. Take advantage of the excellent public transportation to explore other German cities. Join student organizations and sports clubs to meet people. And don't miss the Christmas markets in winter!",
        ...
        funFact:
          "I learned to brew traditional German beer in a student club and now I'm planning to start a microbrewery back in Cyprus!",
        bestMemory:
          "Presenting my sustainable energy project to industry professionals at TU Berlin's innovation showcase and receiving positive feedback.",
      },
    },
    {
      userId: users[3].id,
      ...
      data: {
        ...
        challenges:
          "The formal Austrian communication style took some getting used to after the more relaxed Cypriot approach. The cost of living was higher than expected, especially dining out. Winter was long and dark, but the beautiful Christmas markets and cozy coffeehouses made it bearable.",
        personalGrowth:
        ...
        recommendations:
          "Take advantage of the student discounts for cultural events - Vienna offers so much! Learn some German basics; Austrians appreciate the effort. Explore the coffeehouse culture; it's where you'll have the best conversations. Don't miss day trips to Salzburg and the Danube Valley.",
        wouldRecommend: "Absolutely",
        overallRating: 5,
        socialLifeRating: 4,
        academicRating: 5,
        ...
        photos: [
          {
            ...
            caption:
              "Schönbrunn Palace - weekend study sessions in the gardens",
          },
          {
        ...
        funFact:
          "I wrote my semester thesis in the same coffeehouse where it's rumored Freud used to meet with his colleagues!",
        bestMemory:
          "Attending a psychology conference at the University of Vienna and presenting my research on cultural adaptation to an international audience.",
      },
    },
  ];
  ...
  for (const story of storyData) {
    try {
      const created = await prisma.form_submissions.create({
        data: {
          ...story,
          id: randomUUID(),
          updatedAt: new Date(),
      ...
      console.log(`Error creating story: ${story.title}`, error);
    }
  }
...
async function createSampleAccommodations(users: any[]) {
  const accommodationData = [
    {
      ...
      data: {
        ...
        transportationAccess:
          "Excellent - tram stop right outside, 15 minutes to city center",
        safetyRating: 5,
        wouldRecommend: true,
        additionalNotes:
          "Perfect for students who want to be in the heart of Prague with an international community. The location more than makes up for the basic facilities.",
        photos: [
          {
    ...
    },
    {
      ...
      data: {
        ...
        transportationAccess:
          "Good - metro station 10 minutes walk, bus connections to university",
        safetyRating: 4,
        wouldRecommend: true,
        additionalNotes:
          "Living with locals was the best decision for improving Spanish and understanding Catalan culture. The neighborhood has amazing local bars and restaurants.",
        photos: [
          {
    ...
    },
    {
      ...
      data: {
        ...
        transportationAccess:
          "Excellent - U-Bahn station nearby, direct connection to university",
        safetyRating: 5,
        wouldRecommend: true,
        additionalNotes:
          "Perfect for students who want modern amenities and a structured environment. The international student community here is very active.",
        photos: [
          {
  ...
  for (const accommodation of accommodationData) {
    try {
      ...
      console.log(
        `Error creating accommodation: ${accommodation.title}`,
        error,
      );
    }
  }
...
async function createSampleCourseMatching(users: any[]) {
        ...
        courseMatches: [
          {
            ...
            workload: "Heavy",
            recommendation:
              "Excellent course with real case studies from European companies. Professor brings industry experience.",
            grade: "A-",
          },
          {
            ...
            workload: "Medium",
            recommendation:
              "Great focus on digital marketing trends. Group project with international students was valuable.",
            grade: "B+",
          },
          {
            ...
            workload: "Heavy",
            recommendation:
              "Intense but rewarding. Focused on Eastern European markets which was unique perspective.",
            grade: "B",
          },
        ],
        overallAcademicExperience:
          "The academic level at Charles University was excellent. Professors encouraged critical thinking and international perspectives. The business program has strong connections with local and international companies.",
        ...
        courseMatches: [
          {
            ...
            workload: "Very Heavy",
            recommendation:
              "Cutting-edge course with latest technology. Lab work with industrial robots. Essential for modern engineers.",
            grade: "1.7",
          },
          {
            ...
            workload: "Heavy",
            recommendation:
              "Germany leads in green technology. Excellent insights into renewable energy systems and sustainable design.",
            grade: "1.3",
          },
        ],
        overallAcademicExperience:
          "TU Berlin is world-class for engineering. The combination of theoretical depth and practical application is impressive. Strong industry connections provide real-world context.",
  ...
  for (const course of courseData) {
    try {
      ...
      console.log(`Error creating course matching: ${course.title}`, error);
    }
  }
...
async function createSampleMentorship(users: any[]) {
  const mentorshipData = [
    {
      ...
      data: {
        ...
        mentorshipExperience:
          "Helped 5 students prepare for their exchange to Prague",
        additionalAdvice:
          "Prague is an incredible city for business students! The combination of historical charm and modern business opportunities creates unique learning experiences. Don't hesitate to reach out - I love helping fellow Cypriot students make the most of their exchange!",
        funFact:
          "I started a small consulting business helping Czech companies expand to Mediterranean markets during my exchange!",
        wantToHelp: "yes",
        publicProfile: "yes",
    ...
    },
    {
      ...
      data: {
        ...
        mentorshipExperience:
          "Currently mentoring 3 architecture students planning their exchange",
        additionalAdvice:
          "Barcelona is paradise for architecture students! Study Gaudí's work in person, explore the modernist buildings, and don't miss the opportunity to work on sustainable urban projects. The city itself is your classroom!",
        funFact:
          "I created a digital guide to Barcelona's hidden architectural gems that's now used by the university!",
        wantToHelp: "yes",
        publicProfile: "yes",
        allowPublicContact: "yes",
      },
    },
    {
      ...
      data: {
        ...
        mentorshipExperience:
          "Mentored 8 engineering students, with 6 successfully completing German exchanges",
        additionalAdvice:
          "German engineering education is rigorous but incredibly rewarding. Prepare well academically, learn basic German, and embrace the precision-focused culture. The networking opportunities in Germany's industrial sector are unmatched!",
        funFact:
          "I interned at BMW during my exchange and now work on sustainable automotive projects inspired by German innovation!",
        wantToHelp: "yes",
        publicProfile: "yes",
        allowPublicContact: "yes",
      },
  ...
  for (const mentor of mentorshipData) {
    try {
      ...
      console.log(`Error creating mentorship: ${mentor.title}`, error);
    }
  }
...
async function createSampleLivingExpenses(users: any[]) {
  const expenseData = [
    {
      ...
      data: {
        ...
        costComparison:
          "About 30-40% cheaper than Cyprus for food and entertainment",
        unexpectedExpenses: [
    ...
    },
    {
      ...
      data: {
        ...
        costComparison:
          "Similar to Cyprus but more expensive for accommodation",
        unexpectedExpenses: [
        ...
        budgetAccuracy:
          "Went over budget by 15% - underestimated social expenses",
      },
    },
  ];
  ...
  for (const expense of expenseData) {
    try {
      ...
      console.log(`Error creating living expense: ${expense.title}`, error);
    }
  }
