...
export default function CourseMapping({
  ...
  const [foreignUniversity, setForeignUniversity] = useState(
    propForeignUniversity || "",
  );
  const [cyprusUniversity, setCyprusUniversity] = useState(
    propCyprusUniversity || "",
  );
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  We're working on integrating live course mapping data. This
                  feature will show real course equivalencies and transfer
                  approvals.
                </p>
              </div>
            </div>
