...
export default function DebugBasicInfo({ onClose }: DebugBasicInfoProps) {
  const { getFormData, getDraftData, getSubmittedData, submissions } = useFormSubmissions();
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">getFormData('basic-info') Result:</h3>
            <pre className="bg-gray-100 p-3 rounded text-xs overflow-x-auto">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">getDraftData('basic-info') Result:</h3>
            <pre className="bg-gray-100 p-3 rounded text-xs overflow-x-auto">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">getSubmittedData('basic-info') Result:</h3>
            <pre className="bg-gray-100 p-3 rounded text-xs overflow-x-auto">
          ...
          {basicInfoFormData && (
            <div>
              ...
              <div className="bg-yellow-50 p-3 rounded">
                <p><strong>hostCity:</strong> {basicInfoFormData.hostCity || 'MISSING'}</p>
                <p><strong>hostCountry:</strong> {basicInfoFormData.hostCountry || 'MISSING'}</p>
                <p><strong>hostUniversity:</strong> {basicInfoFormData.hostUniversity || 'MISSING'}</p>
              </div>
            </div>
          )}
        </div>
