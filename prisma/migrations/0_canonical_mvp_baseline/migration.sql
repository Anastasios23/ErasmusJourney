...
-- CreateTable
CREATE TABLE "public"."public_destination_read_models" (
    "slug" TEXT NOT NULL,
    "city" TEXT NOT NULL,
    "country" TEXT NOT NULL,
    "hostUniversityCount" INTEGER NOT NULL,
    "submissionCount" INTEGER NOT NULL,
    "latestReportSubmittedAt" TIMESTAMP(3),
    "averageRent" DOUBLE PRECISION,
    "averageMonthlyCost" DOUBLE PRECISION,
    "detail" JSONB NOT NULL,
    "accommodation" JSONB NOT NULL,
    "courseEquivalences" JSONB NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "public_destination_read_models_pkey" PRIMARY KEY ("slug")
);
...
-- CreateTable
CREATE TABLE "public"."CourseMapping" (
    "id" TEXT NOT NULL,
    "experienceId" TEXT NOT NULL,
    "universityId" TEXT NOT NULL,
    "homeCourseCode" TEXT,
    "homeCourseName" TEXT NOT NULL,
    "homeCredits" DOUBLE PRECISION,
    "hostCourseCode" TEXT,
    "hostCourseName" TEXT NOT NULL,
    "hostCredits" DOUBLE PRECISION,
    "grade" TEXT,
...
-- CreateIndex
CREATE INDEX "applications_homeUniversityId_idx" ON "public"."applications"("homeUniversityId");
...
-- CreateIndex
CREATE INDEX "public_destination_read_models_country_city_idx" ON "public"."public_destination_read_models"("country", "city");

-- CreateIndex
CREATE INDEX "public_destination_read_models_submissionCount_city_idx" ON "public"."public_destination_read_models"("submissionCount", "city");
...
-- CreateIndex
CREATE INDEX "CourseMapping_universityId_idx" ON "public"."CourseMapping"("universityId");

-- CreateIndex
CREATE INDEX "CourseMapping_homeCourseName_idx" ON "public"."CourseMapping"("homeCourseName");

-- CreateIndex
CREATE INDEX "CourseMapping_hostCourseName_idx" ON "public"."CourseMapping"("hostCourseName");

-- CreateIndex
CREATE INDEX "AccommodationReview_experienceId_idx" ON "public"."AccommodationReview"("experienceId");

-- CreateIndex
CREATE INDEX "AccommodationReview_pricePerMonth_idx" ON "public"."AccommodationReview"("pricePerMonth");

-- CreateIndex
CREATE INDEX "AccommodationReview_type_idx" ON "public"."AccommodationReview"("type");
...
-- AddForeignKey
ALTER TABLE "public"."CourseMapping" ADD CONSTRAINT "CourseMapping_experienceId_fkey" FOREIGN KEY ("experienceId") REFERENCES "public"."erasmus_experiences"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."CourseMapping" ADD CONSTRAINT "CourseMapping_universityId_fkey" FOREIGN KEY ("universityId") REFERENCES "public"."universities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."AccommodationReview" ADD CONSTRAINT "AccommodationReview_experienceId_fkey" FOREIGN KEY ("experienceId") REFERENCES "public"."erasmus_experiences"("id") ON DELETE CASCADE ON UPDATE CASCADE;
