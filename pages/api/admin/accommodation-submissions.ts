...
export default async function handler(
  ...
  return respondWithCanonicalRouteDisabled(res, {
    ...
    details:
      "This legacy admin accommodation submissions route was disabled because accommodation moderation now belongs to the canonical ErasmusExperience workflow.",
  });
}
