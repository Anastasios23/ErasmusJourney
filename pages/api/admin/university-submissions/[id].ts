...
export default async function handler(
  ...
  return respondWithCanonicalRouteDisabled(res, {
    ...
    details:
      "This legacy admin university submission detail route was disabled because peer-course moderation now belongs to the canonical ErasmusExperience workflow.",
  });
}
