...
const errorMessages: Record<string, string> = {
  ...
  ClientFetchError: "Network error occurred. Please check your connection and try again.",
};
            ...
            <CardContent className="space-y-6">
                ...
                {error === "ClientFetchError" && (
                  <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-4">
                    <p className="text-xs text-blue-700">
                      This error is often caused by browser extensions or network issues. 
              ...
              <div className="text-center">
                <p className="text-xs text-gray-500">
                  If the problem persists, please contact support or try signing in later.
                </p>
              </div>
            </CardContent>
          </Card>
