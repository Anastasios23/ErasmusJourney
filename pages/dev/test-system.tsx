...
export default function TestSystem() {
  ...
  const [generationResult, setGenerationResult] = useState<TestResult | null>(
    null,
  );
  ...
  const testSteps = [
    ...
    },
    {
      ...
      links: [
        ...
        {
          title: "Filter: Barcelona",
          url: "/student-accommodations?city=Barcelona",
        },
      ],
    ...
    },
    {
      ...
      links: [
        ...
        {
          title: "Paris Course Data",
          url: "/course-matching-experiences?destination=Paris, France",
        },
      ],
      ...
      links: [
        {
          ...
          url: "/university-exchanges/sorbonne-university",
        },
        {
          title: "ESADE Business School",
          url: "/university-exchanges/esade-business-school",
        },
      ],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta
          name="description"
          content="Test and verify the Erasmus Journey Platform functionality"
        />
      </Head>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Generate test data and verify that all system components are working
            correctly.
          </p>
        </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-gray-600">
                This will create comprehensive test submissions for two
                students:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-blue-800 text-sm">
                    Computer Science → Sorbonne University, Paris
                  </p>
                  <p className="text-blue-700 text-xs mt-1">
                    €1500/month, Cité Universitaire accommodation
                  </p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-green-800 text-sm">
                    Business → ESADE Business School, Barcelona
                  </p>
                  <p className="text-green-700 text-xs mt-1">
                    €1600/month, Shared apartment in Gràcia
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  {generationResult.success && generationResult.details && (
                    <div className="mt-2 text-sm text-green-700">
                      Created {generationResult.details.submissionsCreated}{" "}
                      submissions for {generationResult.details.studentsCreated}{" "}
                      students
                    </div>
                  )}
                </Alert>
