...
class ContentIntegrationService {
  ...
  static async getEnhancedDestinationForPublic(cityOrId: string, country?: string)
  ...
  static async trackContentInteraction(contentId: string, contentType: string, action: string)
}
```
