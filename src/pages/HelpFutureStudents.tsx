      ...
      <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-2xl font-bold text-green-200 mb-1">847</div>
              <div className="text-sm">Active Mentors</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-blue-200 mb-1">3,241</div>
              <div className="text-sm">Students Helped</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-yellow-200 mb-1">4.9</div>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        Students can reach out to you without going through our
                        platform
                      </p>
                      <RadioGroup
          ...
          {formData.wantToHelp === "yes" && (
            <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-blue-200">
              <CardHeader>
                ...
                <p className="text-gray-600">
                  You'll be joining a community of experienced students who are
                  making a difference
                </p>
              </CardHeader>
              <CardContent>
