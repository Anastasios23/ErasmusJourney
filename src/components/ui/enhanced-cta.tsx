          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            {socialProof.studentCount && (
              <div className={cn(
                ...
                isLightVariant ? "bg-blue-100 text-blue-800" : "bg-white/20 text-white"
              )}>
            ...
            {socialProof.rating && (
              <div className={cn(
                "flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium",
                isLightVariant ? "bg-yellow-100 text-yellow-800" : "bg-white/20 text-white"
              )}>
            ...
            {socialProof.recentActivity && (
              <div className={cn(
                "flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium",
                isLightVariant ? "bg-green-100 text-green-800" : "bg-white/20 text-white"
              )}>
            ...
            {socialProof.urgency && (
              <div className={cn(
                ...
                isLightVariant ? "bg-orange-100 text-orange-800" : "bg-white/20 text-white"
              )}>
