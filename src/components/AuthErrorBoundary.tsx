...
export class AuthErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    if (
      ...
      console.warn(
        "NextAuth fetch error detected - this is usually harmless and can be ignored",
      );
    }
  ...
  render() {
    if (this.state.hasError) {
      ...
      if (isNextAuthError) {
        console.warn(
          "Ignoring NextAuth client-side error and rendering normally",
        );
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="space-y-4 text-center">
              <p className="text-sm text-gray-600">
                An error occurred while loading this section. This is usually
                temporary.
              </p>
