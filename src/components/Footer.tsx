  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span
                  className={cn("text-xs", brandingTokens.colors.text.tertiary)}
                >
                  Platform Online
                </span>
              </div>
        ...
        {/* Bottom Section */}
        <div
          className={cn("border-t py-6", brandingTokens.colors.border.default)}
        >
              ...
              {legalLinks.map((link, index) => (
                <div key={link.name} className="flex items-center">
                  ...
                  {index < legalLinks.length - 1 && (
                    <span
                      className={cn("mx-3 text-gray-300 dark:text-gray-600")}
                    >
                      •
                    </span>
                  )}
              ...
              <div className="w-6 h-4 bg-blue-600 rounded-sm flex items-center justify-center">
                <div className="flex space-x-0.5">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <div
                      key={i}
                      className="w-0.5 h-2 bg-yellow-300 rounded-full"
                    />
                  ))}
                </div>
              </div>
