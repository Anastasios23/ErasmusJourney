...
const mockMentors: MentorshipMember[] = [
  ...
  },
  {
    ...
    bio: "Studying psychology at Universita Degli Studi di Milano - Bicocca was transformative. Milan's vibrant academic environment and innovative research in cognitive psychology provided incredible opportunities. The city's blend of culture and modern psychology research was perfect for my development.",
    funFact:
      "I conducted research on bilingual cognition with both Italian and Greek participants!",
    universityInCyprus: "University of Cyprus",
    studyProgram: "Psychology",
    levelOfStudy: "bachelor",
    hostUniversity: "Universita Degli Studi di Milano - Bicocca",
    hostCity: "Milan",
    hostCountry: "Italy",
    ...
    contactInfo: {
      ...
      instagram: "sofia_in_milan",
      linkedin: "https://linkedin.com/in/sofiapapadopoulos",
    },
    contactMethod: "email",
    mentorshipExperience:
      "I help UCY psychology students understand the Italian academic system and research opportunities.",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
